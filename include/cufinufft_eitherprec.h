...
#define CUFINUFFT_SPREAD_INTERP cufinufftf_spread_interp
...
#define CUFINUFFT_SPREAD_INTERP cufinufft_spread_interp
...
int CUFINUFFT_SPREAD_INTERP(CUCPX *h_c, CUCPX *h_fk, CUFINUFFT_PLAN d_plan);
